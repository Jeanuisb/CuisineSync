...
import com.example.cuisinesync.BuildConfig
...
import kotlin.random.Random
    ...
    data class User(
        ...
        val preference3: String,
        val preference4: String,
        val preference5: String
    )


    fun getMongoClient(): com.mongodb.client.MongoClient {
        return MongoClients.create(BuildConfig.MONGO_LOGIN)
    }
    ...
    fun fetchRestaurantRecommendations(cuisine: String, location: String): List<YelpBusiness> {
        ...
        val businesses: List<Map<String, Any>> =
            yelpResponse["businesses"] as List<Map<String, Any>>
